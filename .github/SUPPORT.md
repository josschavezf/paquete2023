# Getting help with `paquete2023`

Thank you for using `paquete2023`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/paquete2023`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/paquete2023),
...
[search issues and pull requests](https://github.com/josschavezf/paquete2023/issues)
